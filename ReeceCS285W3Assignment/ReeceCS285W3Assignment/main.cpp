...
int main() {
    ...
    accountsList[0] = new checkingAccount("Bill", 10200,25000, 100, 0.012,10.00, 10);
    accountsList[1] = new checkingAccount("Bob", 10210, 10000, 100, 0.0099,15.00, 10);
    accountsList[2] = new savingsAccount("Susan", 90001, 20000,0.031);
    accountsList[3] = new savingsAccount("Steve", 90002, 50000,0.041);
    accountsList[4] = new checkingAccount("Sally", 10220, 4999, 100,0.0079,20.00, 10);
